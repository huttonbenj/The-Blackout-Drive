 ...
 * 110+ categorized prompts. Tap to populate the chat input.
...
function togglePromptPanel(force) {
  ...
  if (opening) {
    ...
    if (typeof closeAllPanels === 'function') closeAllPanels(true);
...
function _usePrompt(text) {
  ...
  // Panel stays open — user can browse and try more prompts
}
