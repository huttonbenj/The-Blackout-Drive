...
#   8. Where There Is No Doctor PDF
#
...
# ============================================================
# SECTION 1: KIWIX ZIM ARCHIVES
# ============================================================
echo -e "  ${BOLD}── ZIM Archives (Offline Wikipedia) ─────────────────${NC}"
echo ""

# Wikipedia: Medicine sub-topic (English) — most critical
# Source: https://library.kiwix.org/#lang=eng&category=wikipedia
# The "medicine" subset is ~700MB vs full English at 90GB
download_file \
    "Wikipedia (Medicine)" \
    "https://download.kiwix.org/zim/wikipedia/wikipedia_en_medicine_maxi_2024-08.zim" \
    "$ZIM_DIR/wikipedia_en_medicine.zim" \
    "700"

# Wikipedia: Wilderness / Survival topics
download_file \
    "Wikipedia (Outdoor Survival)" \
    "https://download.kiwix.org/zim/wikipedia/wikipedia_en_wp10_maxi_2024-07.zim" \
    "$ZIM_DIR/wikipedia_en_survival.zim" \
    "600"

# Wiktionary — offline dictionary (useful when communications down)
download_file \
    "Wiktionary English" \
    "https://download.kiwix.org/zim/wiktionary/wiktionary_en_all_maxi_2024-08.zim" \
    "$ZIM_DIR/wiktionary_en.zim" \
    "900"
...
download_file \
    ...
    "$BOOKS_DIR/where_there_is_no_dentist.pdf" \
    "8"
