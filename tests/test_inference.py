...
# Assemble the prompt exactly as dispatch.py does
...
user_prompt = """[LIVE MESH STATE — 2 nodes known]
  ...
  - Blackout Field Unit 01 [!0c2ddfda] (SENDER): heard 420s ago, GPS STALE (last seen 7 min ago): 32.47964, -90.09889 (alt 107m), Battery: unknown
...
Query from Blackout Field Unit 01: where are you"""
