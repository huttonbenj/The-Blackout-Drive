...
### D-001: AI Persona Name → DOOMSDAY
**Date:** 2026-05-07  
**Status:** Final  
**Decision:** The AI model persona is named `DOOMSDAY`.  
**Rationale:** Aligns with the product brand ("Doomsday Drive"), is memorable, and communicates the survivalist use case immediately. Creates brand consistency between product name and AI identity.  
**Implications:** The Ollama Modelfile will create a model named `doomsday`. The UI will display "DOOMSDAY" as the AI name. Marketing copy will reference "Ask DOOMSDAY."
